...
package com.github.masseguillaume.service.eval

import com.github.masseguillaume.service.eval._
import com.github.masseguillaume.service.eval.string._
...
class Eval(target: Option[File]) {
  ...
  case class CompilerException( m: List[Tuple3[Position,String,Int]] ) extends Exception("Compiler exception")
}
